<?php $__env->startSection('title', 'Sign in - NutriAssist'); ?>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-8">
                ...
                <div>
                    ...
                    <input id="email" name="email" type="email" autocomplete="email" required value="<?php echo e(old('email')); ?>" 
                           class="w-full px-5 py-4 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 shadow-sm transition-all duration-200 text-lg <?php $__errorArgs = ['email'];
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password" name="password" type="password" autocomplete="current-password" required 
                               class="w-full pr-12 pl-5 py-4 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 shadow-sm transition-all duration-200 text-lg <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 ring-1 ring-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <label class="flex items-center">
                    ...
                    <div class="pt-4 mt-4 border-t border-slate-200">
                        <a href="<?php echo e(route('admin.login')); ?>" class="block w-full text-center bg-orange-50 border border-orange-200 rounded-2xl px-6 py-3 text-sm font-semibold text-orange-700 hover:bg-orange-100 transition-colors">
                            👨‍💼 Admin Login
                        </a>
                    </div>
                </div>
        ...
        <div class="text-center space-y-2">
            <p class="text-sm text-slate-600">
                Don't have an account? <a href="<?php echo e(route('register')); ?>" class="font-semibold text-emerald-600 hover:text-emerald-500 transition-colors duration-200">Create one now</a>
            </p>
        </div>
    </div>
</main>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/nico/Herd/N.I.K.A/resources/views/auth/login.blade.php ENDPATH**/ ?>