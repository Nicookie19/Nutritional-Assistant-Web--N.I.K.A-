...
<?php $__env->startSection('title', 'NutriAssist Admin'); ?>
<?php $__env->startSection('body_class', 'admin-app'); ?>
...
<div class="portal-shell">
    <header class="admin-header">
        <div class="admin-header__top">
            ...
            <form method="POST" action="<?php echo e(route('logout')); ?>" class="admin-header__actions">
                <?php echo csrf_field(); ?>
        ...
        <nav class="admin-nav">
            <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route($item['route'])); ?>" class="admin-nav__link <?php echo e($page === $key ? 'is-active' : ''); ?>">
    ...
    <main class="portal-content portal-content--admin">
        ...
        <?php if($page === 'dashboard'): ?>
            ...
            <section class="portal-grid portal-grid--three">
                <?php $__currentLoopData = $adminCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="portal-card portal-stat-card">
                        <div class="portal-stat-card__top">
                            <h2><?php echo e($card['label']); ?></h2>
                            <span class="portal-mini-icon <?php echo e($card['tone']); ?>"></span>
                        </div>
                        <div class="portal-stat-card__value"><?php echo e($card['value']); ?></div>
                        <p class="portal-stat-card__admin-meta"><?php echo e($card['meta']); ?></p>
                    </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </section>
            ...
            <section class="portal-grid portal-grid--two">
                <article class="portal-card portal-chart-card">
                    ...
                    <div class="portal-bar-chart portal-bar-chart--user mt-6">
                        ...
                        <?php $__currentLoopData = [840, 920, 1050, 1140, 1190, 1220, 1247]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="portal-bar-chart__item">
                                <span class="portal-bar-chart__bar" style="height: <?php echo e(max(($bar / 1400) * 100, 12)); ?>%; background:#5b82ef;"></span>
                                <label><?php echo e(['Sep', 'Oct', 'Nov', 'Dec', 'Jan', 'Feb', 'Mar'][$index]); ?></label>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </article>
                ...
                <article class="portal-card portal-chart-card">
                    ...
                    <div class="portal-bar-chart mt-6">
                        ...
                        <?php $__currentLoopData = [3250, 3480, 3190, 3600, 3770, 3920, 3490]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="portal-bar-chart__item">
                                <span class="portal-bar-chart__bar" style="height: <?php echo e(max(($bar / 4000) * 100, 12)); ?>%"></span>
                                <label><?php echo e(['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'][$index]); ?></label>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </article>
            ...
            <section class="portal-card">
                ...
                <div class="portal-health-list">
                    ...
                    <article class="portal-health-list__item portal-tone-yellow">
                        ...
                        <p><?php echo e($feedbackRequests->where('status', 'pending')->count() + 21); ?> feedback requests pending assignment</p>
                    </article>
                </div>
            </section>
        <?php endif; ?>
        ...
        <?php if($page === 'users'): ?>
            ...
            <section class="portal-grid portal-grid--four">
                <article class="portal-card portal-admin-number"><h2>Total Users</h2><strong><?php echo e($users->count()); ?></strong></article>
                <article class="portal-card portal-admin-number"><h2>Active</h2><strong class="is-green"><?php echo e($activeUsersCount); ?></strong></article>
                <article class="portal-card portal-admin-number"><h2>Inactive</h2><strong><?php echo e($inactiveUsersCount); ?></strong></article>
                <article class="portal-card portal-admin-number"><h2>With Pending Feedback</h2><strong class="is-red"><?php echo e($users->filter(fn ($user) => $user->feedbackRequests->where('status', '!=', 'completed')->isNotEmpty())->count()); ?></strong></article>
            </section>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="flex flex-col">
                                                <span class="font-medium text-slate-900"><?php echo e($user->full_name ?: 'Unnamed user'); ?></span>
                                                <span class="text-xs text-slate-500"><?php echo e(optional($user->created_at)->format('M d, Y')); ?></span>
                                            </div>
                                        </td>
                                        <td><?php echo e($user->activeDietitian?->name ?? 'Unassigned'); ?></td>
                                        <td>
                                            <div class="flex flex-col">
                                                <span class="font-medium text-slate-900"><?php echo e($bmi ? number_format($bmi, 1) : '—'); ?></span>
                                                <span class="text-xs <?php echo e($bmi !== null && $bmi >= 25 ? 'text-orange-600' : 'text-emerald-600'); ?>">
                                                    <?php if($bmi === null): ?>
                                                        No data
                                                    <?php elseif($bmi >= 30): ?>
                                                        Obese
                                        ...
                                        <td class="text-slate-600"><?php echo e($user->primary_goal ?: 'Not set'); ?></td>
                                        <td class="text-center font-semibold text-slate-700"><?php echo e($user->foodLogEntries->count()); ?></td>
                                        <td><span class="portal-pill <?php echo e($status === 'active' ? 'portal-pill--active' : 'portal-pill--inactive'); ?>"><?php echo e($status); ?></span></td>
                                        <td>
                                            <a href="<?php echo e(route('admin.users', ['edit_user' => $user->id])); ?>" class="text-orange-600 font-semibold">Open Hub</a>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                ...
                <section class="space-y-6" style="display:flex;flex-direction:column;gap:1.5rem;">
                        ...
                        <?php if($editingUser): ?>
                            ...
                            <div class="grid gap-3 sm:grid-cols-2 mb-6">
                                <div class="portal-card portal-tone-blue">
                                    <strong><?php echo e($editingUser->full_name ?: 'Unnamed user'); ?></strong>
                                    <p class="text-sm text-slate-600 mt-1">Goal: <?php echo e($editingUser->primary_goal ?: 'Not set'); ?></p>
                                </div>
                                <div class="portal-card portal-tone-green">
                                    <strong><?php echo e($editingUser->activeDietitian?->name ?? 'Unassigned dietitian'); ?></strong>
                                    <p class="text-sm text-slate-600 mt-1">Current support owner</p>
                                </div>
                                <div class="portal-card">
                                    <strong><?php echo e($editingUser->foodLogEntries->count()); ?></strong>
                                    <p class="text-sm text-slate-500 mt-1">Food log entries</p>
                                </div>
                                <div class="portal-card">
                                    <strong><?php echo e($editingUser->plannedMealEntries->count()); ?></strong>
                                    <p class="text-sm text-slate-500 mt-1">Planned meals</p>
                                </div>
                                <div class="portal-card">
                                    <strong><?php echo e($editingUser->activeMealPlan?->name ?? 'No active plan'); ?></strong>
                                    <p class="text-sm text-slate-500 mt-1">Current meal plan</p>
                                </div>
                                <div class="portal-card">
                                    <strong><?php echo e($pendingFeedbackCount); ?></strong>
                                    <p class="text-sm text-slate-500 mt-1">Pending feedback requests</p>
                                </div>
                            </div>

                            <form method="POST" action="<?php echo e(route('admin.users.update', $editingUser)); ?>" class="space-y-4">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="grid gap-4 sm:grid-cols-2">
                                    <label class="portal-field">
                                        <span>Full name</span>
                                        <input type="text" name="full_name" value="<?php echo e(old('full_name', $editingUser->full_name)); ?>">
                                    </label>
                                    <label class="portal-field">
                                        <span>Age</span>
                                        <input type="number" name="age" value="<?php echo e(old('age', $editingUser->age)); ?>">
                                    </label>
                                    <label class="portal-field">
                                        <span>Gender</span>
                                        <input type="text" name="gender" value="<?php echo e(old('gender', $editingUser->gender)); ?>">
                                    </label>
                                    <label class="portal-field">
                                        <span>Activity level</span>
                                        <input type="text" name="activity_level" value="<?php echo e(old('activity_level', $editingUser->activity_level)); ?>">
                                    </label>
                                    <label class="portal-field">
                                        <span>Primary goal</span>
                                        <input type="text" name="primary_goal" value="<?php echo e(old('primary_goal', $editingUser->primary_goal)); ?>">
                                    </label>
                                    <label class="portal-field">
                                        <span>Height (cm)</span>
                                        <input type="number" step="0.1" name="height_cm" value="<?php echo e(old('height_cm', $editingUser->height_cm)); ?>">
                                    </label>
                                    <label class="portal-field">
                                        <span>Current weight (kg)</span>
                                        <input type="number" step="0.1" name="current_weight_kg" value="<?php echo e(old('current_weight_kg', $editingUser->current_weight_kg)); ?>">
                                    </label>
                                    <label class="portal-field">
                                        <span>Target weight (kg)</span>
                                        <input type="number" step="0.1" name="target_weight_kg" value="<?php echo e(old('target_weight_kg', $editingUser->target_weight_kg)); ?>">
                                    </label>
                                </div>

                                <div class="grid gap-4 sm:grid-cols-3">
                                    <article class="portal-card">
                                        <strong><?php echo e($editingBmi ? number_format($editingBmi, 1) : '—'); ?></strong>
                                        <p class="text-sm text-slate-500 mt-1">Current BMI</p>
                                    </article>
                                    <article class="portal-card">
                                        <strong><?php echo e($editingUser->starting_weight_kg ? number_format((float) $editingUser->starting_weight_kg, 1) . ' kg' : '—'); ?></strong>
                                        <p class="text-sm text-slate-500 mt-1">Starting weight</p>
                                    </article>
                                    <article class="portal-card">
                                        <strong><?php echo e($editingUser->target_weight_kg ? number_format(max((float) $editingUser->current_weight_kg - (float) $editingUser->target_weight_kg, 0), 1) . ' kg' : '—'); ?></strong>
                    ...
                    <?php if($editingUser): ?>
                        <article class="portal-card">
                            ...
                            <div class="space-y-3">
                                <?php $__empty_1 = true; $__currentLoopData = $editingUser->foodLogEntries->sortByDesc('entry_date')->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="flex items-center justify-between rounded-2xl border border-slate-100 px-4 py-3">
                                        <div>
                                            <strong class="text-slate-900"><?php echo e($entry->food_name); ?></strong>
                                            <p class="text-sm text-slate-500"><?php echo e($entry->meal_slot); ?> • <?php echo e(optional($entry->entry_date)->format('M d, Y')); ?></p>
                                        </div>
                                        <span class="text-sm font-semibold text-slate-700"><?php echo e($entry->calories); ?> cal</span>
                                    </div>
        ...
        <?php if($page === 'dietitians'): ?>
            ...
            <section class="portal-grid portal-grid--two">
                <?php $__currentLoopData = $dietitianNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="portal-card flex items-center justify-between p-6">
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 font-bold border border-slate-200">
                                <?php echo e(substr($name, 4, 1)); ?><?php echo e(substr(explode(' ', $name)[2], 0, 1)); ?>

                            </div>
                            <div>
                                <h3 class="font-bold text-slate-900"><?php echo e($name); ?></h3>
                                <p class="text-sm text-slate-500"><?php echo e($dietitianSpecialties[$index]); ?></p>
                            </div>
                        </div>
                        <div class="text-right">
                            <span class="block font-bold text-slate-900"><?php echo e($dietitianPatients[$index]); ?> Patients</span>
                            <span class="text-xs text-orange-500 font-semibold">★ <?php echo e($dietitianRatings[$index]); ?> Rating</span>
                        </div>
                    </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </section>
            ...
            <section class="portal-card">
                <div class="portal-table-wrap">
                    <table class="portal-table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $feedbackRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="font-medium"><?php echo e($request->userExperience?->full_name ?? 'User'); ?></td>
                                <td><?php echo e($request->dietitian?->name ?? 'Unassigned'); ?></td>
                                <td><?php echo e(Str::title($request->topic)); ?></td>
                                <td><span class="portal-badge <?php echo e($request->priority === 'high' ? 'portal-badge--red' : 'portal-badge--slate'); ?>"><?php echo e($request->priority); ?></span></td>
                                <td><span class="portal-pill <?php echo e($request->status === 'completed' ? 'portal-pill--active' : 'portal-pill--inactive'); ?>"><?php echo e($request->status); ?></span></td>
                                <td class="text-slate-500"><?php echo e($request->submitted_on->format('M d, Y')); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
            ...
            <section class="portal-grid portal-grid--two">
                <article class="portal-card">
                    ...
                    <div class="flex items-center justify-center p-8">
                        <div class="w-48 h-48 rounded-full border-8 border-slate-50 shadow-inner" style="background: <?php echo e($bmiPieStyle); ?>;"></div>
                ...
                <article class="portal-card">
                    ...
                    <div class="flex items-center justify-center p-8">
                        <div class="w-48 h-48 rounded-full border-8 border-slate-50 shadow-inner" style="background: <?php echo e($goalPieStyle); ?>;"></div>
                        <div class="ml-12 space-y-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/nico/Herd/N.I.K.A/resources/views/admin-portal.blade.php ENDPATH**/ ?>